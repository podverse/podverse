# Feature: mgmt-user-forms (Part 1)
...
>
> **10-Session Limit**: Each part file is limited to 10 sessions. When adding Session 11, create `mgmt-user-forms-part-02.md`.
...
- GitHub Issues: None
- Branch: feature/mgmt-user-forms
