# Feature: add-x-number-of-feeds (Part 1)
...
>
> **10-Session Limit**: Each part file is limited to 10 sessions. When adding Session 11, create `add-x-number-of-feeds-part-02.md`.
...
- GitHub Issues: https://github.com/podverse/podverse/issues/112
- Branch: feature/add-x-number-of-feeds
