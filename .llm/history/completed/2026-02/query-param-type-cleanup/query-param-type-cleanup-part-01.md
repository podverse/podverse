# Feature: query-param-type-cleanup (Part 1)
...
>
> **10-Session Limit**: Each part file is limited to 10 sessions. When adding Session 11, create `query-param-type-cleanup-part-02.md`.
