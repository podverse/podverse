# Feature: external-services-split (Part 1)
...
>
> **10-Session Limit**: Each part file is limited to 10 sessions. When adding Session 11, create `external-services-split-part-02.md`.
...
- GitHub Issues: https://github.com/podverse/podverse/issues/41
- Branch: chore/external-services-split
