# Feature: fix-root-api-route (Part 1)
...
>
> **10-Session Limit**: Each part file is limited to 10 sessions. When adding Session 11, create `fix-root-api-route-part-02.md`.
...
- GitHub Issues: https://github.com/podverse/podverse/issues/105
- Branch: fix/fix-root-api-route
