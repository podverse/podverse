# Feature: test-assets-local-server (Part 1)
...
>
> **10-Session Limit**: Each part file is limited to 10 sessions. When adding Session 11, create `test-assets-local-server-part-02.md`.
...
- Branch: feature/test-assets-local-server
