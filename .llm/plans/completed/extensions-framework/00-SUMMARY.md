...
- 2026-05-09: Branch B selected for step `08` (single-emitter already active via
  `<ExtensionHeadScripts />`; no parallel layout-level Cloudflare script emitter to
  consolidate). If `cloudflare_web_analytics_env_6f142d3e` ships later, its direct
  root-layout rendering step should be omitted.
