...
| MB1 confirm request shaping | `packages/v4v-metaboost/src/mb1ConfirmPayment.ts` | Keep in `@podverse/v4v-metaboost` | Move now (stay) | Standard-specific payload logic should remain standard package concern | Low |
