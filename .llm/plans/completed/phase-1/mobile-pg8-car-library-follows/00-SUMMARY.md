...
app-closed scene). See `.llm/plans/completed/phase-1/mobile-pg8-car-*`.
...
- **12.21:** create `docs/proposals/mobile/_master-plan_/phase-1/details/400-car-parallel-worktree.md`
