...
**Details:**
[384-spike-cache-read-no-js-ios](/docs/proposals/mobile/_master-plan_/phase-1/details/384-spike-cache-read-no-js-ios.md),
[385-spike-cache-read-no-js-android](/docs/proposals/mobile/_master-plan_/phase-1/details/385-spike-cache-read-no-js-android.md)
...
6. Archive this plan set to `.llm/plans/completed/phase-1/mobile-pg8-car-native-cache/` per
   **plan-completion**.
