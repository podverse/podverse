...
```
Read and execute .llm/plans/completed/mobile-pg5-video-gaps/01-video-surface-reparent.md
...
```
Read and execute .llm/plans/completed/mobile-pg5-video-gaps/02-mobile-unit-test-ci-gate.md
