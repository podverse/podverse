...
2. **Docs — update to the proven path:**
   ...
   - Master plan detail `docs/proposals/mobile/_master-plan_/details/386-ios-carplay-scene-config.md`
...
4. **Archive:** move this plan set from `.llm/plans/active/mobile-carplay-app-closed-scene/` to the
   mirrored `.llm/plans/completed/mobile-carplay-app-closed-scene/` once the proof passes.
