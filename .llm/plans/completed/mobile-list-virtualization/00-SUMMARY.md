...
[597](/docs/proposals/mobile/_master-plan_/details/597-list-virtualization-polish.md) — it is a
...
- Master plan Ship-bar row (line ~53) + step 23.3; detail
  `docs/proposals/mobile/_master-plan_/details/597-list-virtualization-polish.md`.
