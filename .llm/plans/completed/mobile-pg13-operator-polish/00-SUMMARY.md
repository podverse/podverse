...
> [595](/docs/proposals/mobile/_master-plan_/details/595-operator-polish-checklist.md) /
> [596](/docs/proposals/mobile/_master-plan_/details/596-operator-polish-apply-briefs.md) and the
...
| --- | --- | --- | --- |
| 23.1 | [595-operator-polish-checklist](/docs/proposals/mobile/_master-plan_/details/595-operator-polish-checklist.md) | Auto | **Agent-actionable now:** create the checklist **scaffold** doc (one row per screen, pass/fail + notes). Operator then walks screens and fills it. |
| 23.2 | [596-operator-polish-apply-briefs](/docs/proposals/mobile/_master-plan_/details/596-operator-polish-apply-briefs.md) | Codex 5.3 | **Gated:** apply operator briefs to concrete files once briefs exist. Cannot start until 23.1 is filled and at least one brief is written. |
| 23.3 | [597-list-virtualization-polish](/docs/proposals/mobile/_master-plan_/details/597-list-virtualization-polish.md) | Codex 5.3 | Part **(a)** baseline virtualization already **done** (`.llm/plans/completed/mobile-list-virtualization/`). Part **(b)** FlashList/windowing *tuning* stays deferred — jank-gated, not part of this set. |
