...
applyTo: "apps/**/lib/startup/validation.ts,apps/workers/src/lib/startup/validation.ts"
---

# Startup validation order vs env files

Use the **startup-validation-env-order** skill
(`.llm/exports/github-copilot/skills/startup-validation-env-order/SKILL.md`) for full detail.
