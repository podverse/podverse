...
When a file mixes server-side keys with `NEXT_PUBLIC_*`, list **all non-`NEXT_PUBLIC_*` assignments first**, blank line, then all `NEXT_PUBLIC_*`. See `.llm/exports/github-copilot/skills/env-file-formatting/SKILL.md`.
