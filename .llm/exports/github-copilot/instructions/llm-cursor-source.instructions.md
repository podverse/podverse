...
**Exception — pipeline development only:** if you are changing [scripts/llm/](scripts/llm/) export code, you may set `LLM_EXPORT_ALLOW_LOCAL=1` to run a local sync; see [docs/development/llm/README.md](docs/development/llm/README.md).

If you use another LLM or editor, follow [docs/development/llm/README.md](docs/development/llm/README.md) and, if needed, [docs/development/llm/LLM-EDITOR-ALIGNMENT-PROMPT.md](docs/development/llm/LLM-EDITOR-ALIGNMENT-PROMPT.md).
