...
Internal imports within `apps/management-api/src` use **`@management-api/*`** → `src/*` (full directory name — not `@mgmt-api`). See `.llm/exports/github-copilot/instructions/app-internal-import-aliases.instructions.md`.
