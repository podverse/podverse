...
Internal imports within `apps/api/src` use **`@api/*`** → `src/*` (matches the `apps/api/` directory name). Do not abbreviate. See `.llm/exports/github-copilot/instructions/app-internal-import-aliases.instructions.md`.
