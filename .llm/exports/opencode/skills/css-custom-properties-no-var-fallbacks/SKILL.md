...
Workspace rule: [`.llm/exports/opencode/instructions/css-custom-properties-no-var-fallbacks.instructions.md`](../../rules/css-custom-properties-no-var-fallbacks.mdc).
