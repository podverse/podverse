...
For **whether** a table should sort at all, see **tables-support-sorting** (`.llm/exports/opencode/skills/tables-support-sorting/SKILL.md`). For **cookie/path** list prefs, see **sort-prefs-cookie-by-path** (`.llm/exports/opencode/skills/sort-prefs-cookie-by-path/SKILL.md`).
