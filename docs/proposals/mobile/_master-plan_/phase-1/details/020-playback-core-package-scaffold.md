# 020-playback-core-package-scaffold
...
Create packages/playback-core workspace (package.json, tsconfig, eslint, vitest) mirroring helpers-validation.

## Acceptance criteria

- Step 1.1 complete per [001-MASTER-PLAN.md](/docs/proposals/mobile/_master-plan_/phase-1/001-MASTER-PLAN.md)
