...
- Step 3.10 complete per [001-MASTER-PLAN.md](/docs/proposals/mobile/_master-plan_/phase-1/001-MASTER-PLAN.md)
- `.expo/` is gitignored
...
- [001-cursorignore-native-artifacts](/docs/proposals/mobile/_master-plan_/phase-1/details/001-cursorignore-native-artifacts.md)
