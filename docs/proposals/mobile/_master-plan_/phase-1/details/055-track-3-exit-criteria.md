...
- Add Track 3 **exit checklist** to [001-MASTER-PLAN.md](/docs/proposals/mobile/_master-plan_/phase-1/001-MASTER-PLAN.md) (or linked appendix).
...
- Step 3.16 complete per [001-MASTER-PLAN.md](/docs/proposals/mobile/_master-plan_/phase-1/001-MASTER-PLAN.md)
...
- [001-MASTER-PLAN.md PG-2a / Track 3](/docs/proposals/mobile/_master-plan_/phase-1/001-MASTER-PLAN.md)
...
```bash
grep -q 'Track 3' docs/proposals/mobile/_master-plan_/phase-1/001-MASTER-PLAN.md
grep '3\.16\.' docs/proposals/mobile/_master-plan_/phase-1/001-MASTER-PLAN.md | grep -q done || echo 'Mark 3.16 done after operator sign-off'
grep '040-mobile-package-json' docs/proposals/mobile/_master-plan_/phase-1/001-MASTER-PLAN.md
```
