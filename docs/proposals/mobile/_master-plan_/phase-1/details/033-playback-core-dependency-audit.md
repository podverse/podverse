# 033-playback-core-dependency-audit
...
Ensure playback-core depends only on @podverse/helpers.

## Acceptance criteria

- Step 1.14 complete per [001-MASTER-PLAN.md](/docs/proposals/mobile/_master-plan_/phase-1/001-MASTER-PLAN.md)
