...
| Document head icons     | `favicon.svg`, `favicon.ico`, `favicon-96x96.png`, `apple-touch-icon.png` under [`apps/web/public/favicon/`](../../apps/web/public/favicon/) | **96×96** PNG; **180×180** typical for Apple touch ([`FavIcons`](../../packages/ui/src/components/head/FavIcons/FavIcons.tsx)); SVG and ICO cover modern and legacy browsers.                                                                                                                                                                                        |
