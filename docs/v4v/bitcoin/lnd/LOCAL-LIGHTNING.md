...
- **Makefile:** `makefiles/local/Makefile.local.v4v.mk` is the single shared entry for all V4V local
  targets; LN targets (`local_ln_*`, `local_lnd_http_proxy_*`, `local_ln_recipient_nodes_*`) are
...
| `makefiles/local/Makefile.local.v4v.mk`                        | Make targets for local*ln*\* (included by makefiles/local/Makefile.local.infra.mk)                                |
| `makefiles/local/Makefile.local.apps.mk`                       | Make targets for local_nuke_rebuild_run_v4v                                                                       |
