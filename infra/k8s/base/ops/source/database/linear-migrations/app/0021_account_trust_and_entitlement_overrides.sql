...
ADD COLUMN account_trust_tier_id integer NOT NULL DEFAULT 1;

ALTER TABLE account_membership_status
ADD COLUMN allow_directory_add_by_rss boolean NULL;

ALTER TABLE account_membership_status
ADD COLUMN max_add_by_rss_feeds integer NULL;

ALTER TABLE account_membership_status
ADD COLUMN max_manual_refreshes_per_hour integer NULL;

ALTER TABLE account_membership_status
ADD COLUMN track_stats boolean NULL;

ALTER TABLE account_membership_status
ADD COLUMN allow_notifications boolean NULL;
