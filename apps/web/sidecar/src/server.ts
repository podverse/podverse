...
const requiredKeys = [
  ...
  'NEXT_PUBLIC_POPULARITY_TRACKING_AGREEMENT_DATE',
  'NEXT_PUBLIC_POPULARITY_TRACKING_AGREEMENT_VERSION',
...
function getCategory(key: string): string {
  const map: Record<string, string> = {
    ...
    NEXT_PUBLIC_BRAND_DOMAIN: 'Brand',
    ...
    NEXT_PUBLIC_BRAND_LOGO_SQUARE: 'Brand',
    NEXT_PUBLIC_BRAND_LOGO_SQUARE_100X100: 'Brand',
    ...
    NEXT_PUBLIC_POPULARITY_TRACKING_AGREEMENT_DATE: 'Legal',
    NEXT_PUBLIC_POPULARITY_TRACKING_AGREEMENT_VERSION: 'Legal',
