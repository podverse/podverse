 ...
 * album's remembered order is reachable. `type` (section chip) also stays optional so a clean URL
 * opens on Tracks; an explicit `?type=` selects that chip for this request only.
 */
