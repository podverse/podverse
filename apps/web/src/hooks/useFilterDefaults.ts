...
import { FilterDefaultsPage, updateFilterDefaults, FilterDefaultsForPage } from '../utils/localSettings/localSettings';
 ...
 */
export function useFilterDefaults<P extends FilterDefaultsPage, T extends object>(page: P, filterParams: T) {
