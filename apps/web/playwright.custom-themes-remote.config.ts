...
/** Remote custom theme pack only (minimal fixture) plus a single built-in theme. */
export default defineConfig({
  globalSetup: './e2e/custom-themes-global-setup.mjs',
  testDir: './e2e',
  outputDir: '../../.artifacts/e2e-test-results/web-custom-themes-remote',
  testMatch: '**/custom-themes-remote-only.spec.ts',
  fullyParallel: false,
  workers: 1,
