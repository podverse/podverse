...
test.describe('Main layout navbar chrome', () => {
  test('the home page shows search, account menu, and history controls on a wide viewport', async ({
    page,
  }) => {
  ...
  test('a narrow viewport shows the mobile menu toggle in its closed state', async ({ page }) => {
