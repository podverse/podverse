  ...
  it('returns explicitly set runtime config when available', async () => {
    ...
    setRuntimeConfig({
      env: {
        ...
        NEXT_PUBLIC_APPLE_TOUCH_ICON_URL: undefined,
        NEXT_PUBLIC_BRAND_DOMAIN: undefined,
        NEXT_PUBLIC_BRAND_NAME: 'Podverse Management',
        NEXT_PUBLIC_FAVICON_ICO_URL: undefined,
        NEXT_PUBLIC_FAVICON_PNG_96_URL: undefined,
        NEXT_PUBLIC_FAVICON_SVG_URL: undefined,
        NEXT_PUBLIC_FEATURES_DEFAULT_LOCALE: 'en-US',
        NEXT_PUBLIC_FEATURES_SUPPORTED_LOCALES: 'all-available',
        NEXT_PUBLIC_PWA_BACKGROUND_COLOR: undefined,
        NEXT_PUBLIC_PWA_ICON_192_URL: undefined,
        NEXT_PUBLIC_PWA_ICON_512_URL: undefined,
        NEXT_PUBLIC_PWA_THEME_COLOR: undefined,
