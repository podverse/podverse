...
import { AccountSettingsNotificationController } from '@api/controllers/account/accountSettings/accountSettingsNotification.js';
...
import { AccountSettingsPlaybackController } from '@api/controllers/account/accountSettings/accountSettingsPlayback.js';
...
router.patch('/playback', asyncHandler(AccountSettingsPlaybackController.update));

router.patch('/notification', asyncHandler(AccountSettingsNotificationController.update));
