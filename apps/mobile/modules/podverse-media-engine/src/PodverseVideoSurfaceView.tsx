/**
 * RN component for the ONE shared native video surface.
 *
 ...
 * the full player is a native-stack modal.
 *
 * Never mounts a second player/`<Video>`: both instances point at the same native surface; only one
 * is the active reparent target at a time (driven by `animateVideoSurface`).
 *
