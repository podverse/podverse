...
// Track 12 fills onGetChildren from the native cache (12.1+). JS must never own the browse tree.
// Full app-closed proof is deferred to 12.6 / 12.13 / 12.17.
//
...
class PodverseMediaLibraryService : MediaLibraryService() {
  ...
  private inner class LibraryCallback : MediaLibrarySession.Callback {
    ...
    override fun onGetChildren(
      ...
      // Empty stub tree. Track 12 populates from the native cache (writeLibraryBrowseIndex).
