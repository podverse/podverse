 ...
 *   skills (per-skill SKILL.md), instructions (*.instructions.md), copilot-instructions.md
 * Deterministic; adapted from the former cursor-to-copilot-sync.mjs.
 */
...
/**
 * Replace references to .cursor in markdown so they point at the Copilot export tree.
 ...
 * @param {string} targetRoot - e.g. .../.llm/exports/github-copilot
 * @param {string} exportPathPosix - e.g. .llm/exports/github-copilot
 */
export function exportGithubCopilot(repoRoot, targetRoot, exportPathPosix) {
  ...
  if (fs.existsSync(cursorRules)) {
    ...
    fs.writeFileSync(path.join(targetRoot, 'copilot-instructions.md'), converted, 'utf8');
  }
